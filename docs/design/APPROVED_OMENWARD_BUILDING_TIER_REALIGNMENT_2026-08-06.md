...
`OMW-PLAN-20260828-STAGE1-PREBUILT-EXPLAIN-01` 및 `OMW-PLAN-20260828-FORWARD-DEFENSE-OCCUPATION-NODES-01`이 이 문서의 **Stage 1 직접 설치** 문구만 대체한다. 이 문서의 건물 Tier·전문화 계보는 유지한다.
...
STAGE_1_FORWARD_BASE_DEFENSE_SYSTEM = 2_LOCKED_CONSTRUCTION_NODES + BARRICADE + AUTO_ATTACK_TOWER
