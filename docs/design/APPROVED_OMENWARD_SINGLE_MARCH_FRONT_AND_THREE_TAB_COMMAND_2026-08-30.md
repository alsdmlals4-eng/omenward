...
ELIGIBLE_SLOT_POINTS = WARD_FORWARD_BASE + CLASH_ZONE
SINGLE_FRONT_MAXIMUM_SLOT_CAPACITY = 8
...
- 수호 진영이 안정적으로 수호 전진기지 또는 접전지를 보유할 때만 슬롯 하나가 열린다.
...
```text
TOP_HUD = RESOURCES + COMMAND_PHASE + ACTIVE_TAB
