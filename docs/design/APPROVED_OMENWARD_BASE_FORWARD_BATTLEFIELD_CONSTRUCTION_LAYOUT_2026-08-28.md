...
status: PARTIALLY_SUPERSEDED__FENCE_AND_FORWARD_BARRICADE_REMOVED__COUNTS_RETAINED
...
## 0. 2026-08-28 열린 전장 amendment

`OMW-PLAN-20260828-OPEN-BATTLEFIELD-TOWER-ONLY-01`이 이 문서의 울타리/닫힌 거점 경계와 고정 전진 바리케이드만 supersede한다. 본진의 패드 4개·고정탑 2개, 전진기지의 패드 2개·고정탑 1개, 양측 대칭, Stage 1의 잠긴 패드 규칙은 retained다.
...
아래 original body의 `FORWARD_BARRICADE`, 울타리/토루 경계, 바리케이드 시간 지연 설명은 historical/superseded scope이며 현행 map visual 또는 Phase 2 구현 입력이 아니다.
