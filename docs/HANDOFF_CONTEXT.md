...
current_gate: PHASE2_STORYBOOK_REMAINING_UNIT_RUNTIME_ASSETS__ISSUE_256__SOURCE_SHEETS_GENERATED__TRUE_ALPHA_CELL_EXPORT_PENDING_REVIEW
...
That 2026-08-29 correction was documentation/canon routing only. The later
user-approved terrain and exact Shield Guard pair are now implemented in their
scoped consumers; live runtime and human observation remain separate `NOT_RUN`
gates.
...
ROUTE_STATE_GRAMMAR = WARD_CITADEL_HOME_BASE -> WARD_FORWARD_BASE -> CONTESTED_CLASH_ZONE -> VEIL_FORWARD_BASE -> VEIL_CITADEL_HOME_BASE
PROJECT_CORE_SCENE_VISUAL_BOARD_SCOPE = STRATEGIC_MAP_ONLY__LOWER_UI_STORYBOARD_REMOVED
TARGET_RUNTIME_ASSET = OMW-IMG-20260830-WIDE-CONNECTED-STRATEGIC-FRONT-TERRAIN-V1__IMPLEMENTED__RUNTIME_NOT_RUN
...
CURRENT_SD_UNIT_RUNTIME_READABILITY = SHIELD_GUARD_PAIR_HEADLESS_GEOMETRY_AND_BINDING_VERIFIED__LIVE_READABILITY_NOT_RUN
