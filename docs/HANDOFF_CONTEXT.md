...
9. `docs/design/APPROVED_OMENWARD_NORTH_STAR_V2_1_AUDIT_AND_CORRECTION_BRIEF_2026-08-24.md` when visual/UI scope applies.
10. Project Notion Home + relevant human-facing page.
11. runtime scope가 열렸을 때 actual code/data/scene/test/runtime.
...
FINAL_PLANNING_ADVERSARIAL_REVIEW = PASS_5_OF_5
GITHUB_NOTION_DRIFT_CHECK = PASS
CURRENT = IMPLEMENTATION_AUTHORITY_REQUIRED
IMPLEMENTATION_AUTHORITY = NONE
CORRECTED_NORTH_STAR_IMAGE = USER_EXPLICIT_IMAGE_REQUEST_ONLY
```
