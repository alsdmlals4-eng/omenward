...
class SmokeSimulator:
    def __init__(self, baseline: dict[str, Any], model: dict[str, Any], seed_count: int) -> None:
    ...
    def simulate_batch_numpy(
        ...
        def token_state() -> tuple[Any, Any, Any]:
            ...
            special_sources = special_active.sum(axis=1).astype(np.float64)
            return symbol_counts, reel_length, special_sources / reel_length

        def update_token_share() -> Any:
            nonlocal token_share_max
            _, _, share = token_state()
        ...
        def spin(period: int, index: int, active_mask: Any) -> None:
            ...
            symbol_counts, reel_length, _ = token_state()
        ...
        def snapshot() -> dict[str, Any]:
            ...
            return {
                ...
                "token_share": update_token_share().copy(),
