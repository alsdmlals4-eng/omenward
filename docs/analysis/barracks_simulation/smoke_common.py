...
def write_outputs(output_dir: Path, result: dict[str, Any], stem: str = "smoke_sweep_2000.v2") -> tuple[Path, Path]:
    ...
    fields = [
        ...
        "special_functional_value_index", "decision_failed_thresholds",
    ...
    with csv_path.open("w", encoding="utf-8", newline="") as handle:
        ...
        for row in result["parameter_vectors"]:
            ...
            writer.writerow({
                ...
                "decision_failed_thresholds": "|".join(row["decision_failed_thresholds"]),
