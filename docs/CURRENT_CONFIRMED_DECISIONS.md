...
| `OMW-PLAN-20260828-OPEN-BATTLEFIELD-TOWER-ONLY-01` | 열린 지형 속에서 발견 가능한 고정 건설 패드를 읽는다. 울타리·닫힌 거점·고정 전진 바리케이드는 없고, 각 전진기지는 탑 1개·패드 2개만 갖는다. | `docs/design/APPROVED_OMENWARD_OPEN_BATTLEFIELD_TOWER_ONLY_FORWARD_LAYOUT_2026-08-28.md` | CONFIRMED__PLANNING_ONLY__NOT_IMPLEMENTED |
...
FORWARD_DEFENSE_VISUAL_CANDIDATE = GENERATION_REQUIRED__USER_CONFIRM_LOCK_PENDING
...
5. current open-battlefield handoff owner after this Decision is merged;
...
8. current GDD/Project Core + `APPROVED_OMENWARD_OPEN_BATTLEFIELD_TOWER_ONLY_FORWARD_LAYOUT_2026-08-28.md` + occupation-node owner + relevant owners, treating fixed-barrier/fenced-base wording as superseded;
