...
| `OMW-PLAN-20260828-BASE-FORWARD-BATTLEFIELD-CONSTRUCTION-LAYOUT-01` | 양측 본진은 생산 건물 없이 건설 노드 4개·고정탑 2개, 각 전진기지는 건설 노드 2개·바리케이드 1개·고정탑 1개를 갖는다. | `docs/design/APPROVED_OMENWARD_BASE_FORWARD_BATTLEFIELD_CONSTRUCTION_LAYOUT_2026-08-28.md` | CONFIRMED__PLANNING_ONLY__NOT_IMPLEMENTED |
...
5. `docs/handoffs/2026-08-28-base-forward-battlefield-layout-handoff.md`;
...
8. current GDD/Project Core + `APPROVED_OMENWARD_BASE_FORWARD_BATTLEFIELD_CONSTRUCTION_LAYOUT_2026-08-28.md` + forward-defense owner + relevant owners, treating conflicting older visible-home-building wording as superseded;
