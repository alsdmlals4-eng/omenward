...
|---|---|---|---|
| `OMW-PLAN-20260830-BATTLE-PRIMARY-MARCH-MINIMAP-01` | BATTLE은 가까운 실제 전투 장면을 주 화면으로, 단일 5구간 진행은 읽기 전용 미니맵으로 전환한다. | `docs/design/APPROVED_OMENWARD_BATTLE_PRIMARY_MARCH_MINIMAP_2026-08-30.md` | IMPLEMENTED__FOCUSED_HEADLESS_CONTRACTS_PASS__RUNTIME_NOT_RUN__HUMAN_NOT_RUN |
...
CURRENT_UI_EVIDENCE = BATTLE_PRIMARY_HEADLESS_CONTRACTS_PASS__LIVE_OBSERVATION_NOT_RUN
