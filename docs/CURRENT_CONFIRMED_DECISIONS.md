...
current_planning_track: CURRENT_CANON_RECONCILED_THEN_NORTH_STAR
...
5. Project Notion Home + 관련 사람용 page.
6. 이미지 생성은 사용자 명시 요청이 있을 때만.
7. runtime/human evidence 미실행 항목은 `NOT_RUN / UNVERIFIED` 유지.
8. 구현 전 economy drift와 actual current runtime을 fresh 대조.
