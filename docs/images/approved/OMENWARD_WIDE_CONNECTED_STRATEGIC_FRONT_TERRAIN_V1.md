...
This is the approved terrain-only source for the wide connected battlefield.
...
Godot can resolve this file and the scene consumer is under deterministic
contract coverage. Neither statement proves a live gameplay render, human
readability, final art quality, commercial release rights, or release pass.
