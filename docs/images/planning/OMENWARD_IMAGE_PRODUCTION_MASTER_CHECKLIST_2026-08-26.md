...
current_approved_runtime_asset_source: P0_UNITS_BUILDINGS_SOURCE_BATCH_PLUS_EXISTING_SHIELD_GUARD_PAIR
current_next_brief: BATCH_EDGE_CLEANUP_AND_MASTER_EXPORT_APPROVAL
goal_queue: OMW-IMG-GOALS-20260826-RUNTIME-CONSUMER-COVERAGE-01
goal_queue_status: USER_APPROVED_B_CURRENT
current_gate: BATCH_EDGE_CLEANUP_AND_MASTER_EXPORT_APPROVAL
```
...
| P0 unit/building source batch (24 files) | `APPROVED` source batch | edge cleanup/master export remain separate |
...
CURRENT_GATE = BATCH_EDGE_CLEANUP_AND_MASTER_EXPORT_APPROVAL
NEXT_REQUIRED_ACTION = AWAIT_EXPLICIT_BATCH_EDGE_CLEANUP_AND_MASTER_EXPORT_APPROVAL
