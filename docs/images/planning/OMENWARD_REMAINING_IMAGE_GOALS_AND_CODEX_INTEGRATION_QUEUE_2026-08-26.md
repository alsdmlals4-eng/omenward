...
| `OMW-ASSET-BRIEF-20260826-VEIL-SHIELD-GUARD-01` | next actual asset brief | no image yet | `NEW_REQUIRED` |
...
APPROVED_ACTUAL_GAME_ASSET_SOURCE_COUNT = 1
```
...
- Veil Shield Guard idle V1: transparent; **next generation target**.
- Veil Shield Guard runtime state source/atlas after idle approval.
...
|---:|---|---|---|---|---|---|
| 1 | IMG-01 Shield Guard pair | P0 | Battlefield + token derivatives | Lumern idle APPROVED | Veil idle + pair state sets | Shield pair review; animation contract before mass states |
...
**Current next image production target after B approval:**

```text
CURRENT_GATE = IMG_01_FINAL_TEXT_BRIEF_AWAITING_EXPLICIT_GENERATION_APPROVAL
NEXT_REQUIRED_ACTION = PRESENT_FINAL_TEXT_BRIEF_FOR_ASSET_UNIT_VEIL_SHIELD_GUARD_IDLE_V1
IMAGE_GENERATION = REQUIRES_SEPARATE_EXPLICIT_USER_APPROVAL
```

No image is generated by this audit or by B approval alone.
...
UNBLOCK_WHEN = APPROVED_REQUIRED_IMAGE_GOALS_FOR_CURRENT_PLAYABLE_SCOPE_COMPLETE
