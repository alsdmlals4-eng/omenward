...
status: SUPERSEDED_RESTART_ROUTER__V6_VISUAL_LOCK_SUCCESSOR
...
current_gate: SUPERSEDED__SEE_2026-08-29_OPEN_BATTLEFIELD_V6_VISUAL_LOCK_HANDOFF
...
v6는 2026-08-29 사용자 확정으로 planning lock이 됐다. 다음 restart router는 `docs/handoffs/2026-08-29-open-battlefield-v6-visual-lock-handoff.md`이며, Phase 2 issue·RED test·provenance review·target-resolution runtime QA를 별도로 통과해야 구현을 시작할 수 있다.
