...
current_runtime_status: MACHINE_VERIFIED__BATTLE_PRIMARY_MARCH_MINIMAP__RUNTIME_NOT_RUN
...
SINGLE_MARCH_FRONT_TERRAIN_ASSET = GENERATED_CANDIDATE__USER_REVIEW_PENDING__NOT_BOUND
...
CURRENT_RUNTIME_BLOCKER = BATTLE_PRIMARY_TECHNICAL_SMOKE_AND_HUMAN_USABILITY_REMAIN
```
