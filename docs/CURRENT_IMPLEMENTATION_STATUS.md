...
planning_status: PHASE2_GLOBAL_BUILDING_ROSTER_IMPLEMENTED__MACHINE_VERIFIED__RUNTIME_TARGET_RESOLUTION_REQUIRED
...
PHASE2_PYTHON_CONTRACTS = 561_PASS__1_CI_ONLY_BASE_RECOVERY_CHECKOUT_REQUIRED
