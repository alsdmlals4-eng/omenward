...
current_next_gate: USER_CONFIRM_OPEN_BATTLEFIELD_TOWER_ONLY_PLANNING_BOARD
...
| Base / forward battlefield capacity | CONFIRMED__PLANNING_ONLY | `APPROVED_OMENWARD_OPEN_BATTLEFIELD_TOWER_ONLY_FORWARD_LAYOUT_2026-08-28.md` |
