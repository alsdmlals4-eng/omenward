...
latest_approved_decision: OMW-DEC-20260806-PLANNING-ONBOARDING-COMPLETION-MINIMUM-VALID-PATHS-HUMAN-STOP-SHIP-V1
...
- 제안은 사용자 승인 전 완료 Decision이나 제품 입력으로 취급하지 않는다.
...
COUNTED_AS_APPROVED_GRILLME = FALSE
