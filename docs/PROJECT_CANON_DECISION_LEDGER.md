...
| `OMW-SYNC-20260803-IMPLEMENTATION-STATUS-AND-PENDING-REFRESH-V1` | `MAINTENANCE_SYNC / NON_COUNTER` | 7월 27일에 멈춘 구현 상태·미확정 목록을 8월 3일 main 영웅 정본과 다음 simulation gate에 동기화 | `CURRENT_IMPLEMENTATION_STATUS.md`, `DECISIONS_PENDING.md` |
