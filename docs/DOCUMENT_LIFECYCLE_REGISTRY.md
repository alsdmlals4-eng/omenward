...
[현행] docs/handoffs/2026-08-28-base-forward-battlefield-layout-handoff.md
...
[현행] docs/design/APPROVED_OMENWARD_BASE_FORWARD_BATTLEFIELD_CONSTRUCTION_LAYOUT_2026-08-28.md
...
[증거] docs/audits/OMENWARD_BASE_FORWARD_BATTLEFIELD_LAYOUT_INCIDENT_2026-08-28.md
[증거] docs/reviews/ADVERSARIAL_BASE_FORWARD_BATTLEFIELD_LAYOUT_REVIEW_2026-08-28.md
...
→ USER_CONFIRM = PENDING__V5_BASE_FORWARD_NODE_LAYOUT
→ CURRENT_NEXT = USER_CONFIRM_REVISED_BASE_FORWARD_BATTLEFIELD_PLANNING_BOARD
```

The approved Run Command slice has historical machine-QA evidence, but its close-backdrop visual target is no longer current. The immediate gate is user review of the new visual lock and planning board; image generation remains `USER_AUTHORIZED_AUTONOMOUS_REQUIRED_IMAGES`.
