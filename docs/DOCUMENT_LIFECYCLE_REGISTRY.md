...
- 3/10 계보는 아래 `[대체됨]` 건물 분기 문서가 보존하며, 현행 건물 구조는 `design/APPROVED_OMENWARD_BUILDING_TIER_REALIGNMENT_2026-08-06.md`가 담당한다.
...
- `design/APPROVED_OMENWARD_BUILDING_TIER_REALIGNMENT_2026-08-06.md`: 건물별 Tier 구조와 일반·특수병 병영 분리.
