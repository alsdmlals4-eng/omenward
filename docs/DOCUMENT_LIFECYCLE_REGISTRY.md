...
[현행] docs/design/OMENWARD_GAME_SCREEN_AND_IMAGE_COVERAGE_2026-08-28.md
```
...
[현행] docs/images/planning/OMENWARD_UNIT_ANIMATION_PRODUCTION_CONTRACT_2026-08-26.md
[현행] docs/images/approved/OMENWARD_P0_UNITS_BUILDINGS_CLEANUP_MASTER_EXPORT_V1_2026-08-26.md
[현행] docs/images/candidates/OMENWARD_P0_REMAINDER_CANDIDATE_BATCH_2026-08-26.md
[현행] docs/handoffs/2026-08-26-gpt-work-image-production-handoff.md
```
...
CURRENT_VISUAL_DECISION = OMW-VISUAL-20260828-BATTLEFIELD-MAP-ROULETTE-PICKER-01
→ APPROVED_VISUAL = OMW-IMG-20260828-BATTLEFIELD-BACKDROP-V1
→ TECHNICAL_QA = COMPLETE
→ CURRENT_NEXT = HUMAN_PLAYTEST_FOR_BATTLEFIELD_READABILITY_AND_ROULETTE_INSPECTION
```

The approved Run Command slice has machine-QA evidence; the remaining validation gate is human battlefield readability and roulette inspection. Image generation remains `USER_AUTHORIZED_AUTONOMOUS_REQUIRED_IMAGES`.
