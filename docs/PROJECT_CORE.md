...
2026-09-14 현재 제품 의미는 [재기획 Blueprint](design/OMENWARD_HUMAN_BLUEPRINT_REVIEW_20260911.md)가 소유한다. [현재 owner 등록](DOCUMENT_LIFECYCLE_REGISTRY.md)과 [실행 명세](superpowers/plans/2026-09-11-visible-battle-slice.md)를 따른다. 이 경로는 기존 문서의 안정 진입점이며 아래 옛 제품 정의·3전선·phase는 비교 이력이다. 보안·저장 보호·권리·Git 보호는 계속 적용한다.
