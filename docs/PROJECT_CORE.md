...
BATTLE_PRIMARY_MARCH_MINIMAP = IMPLEMENTED__FOCUSED_HEADLESS_GODOT_CONTRACTS_PASS__RUNTIME_NOT_RUN
...
IMPLEMENTATION_SCOPE = RUN_COMMAND_ORCHESTRATION_FIRST_VERTICAL_SLICE_ONLY
IMPLEMENTATION_EXECUTION = BATTLE_PRIMARY_MARCH_MINIMAP__HEADLESS_CONTRACTS_PASS__RUNTIME_NOT_RUN
