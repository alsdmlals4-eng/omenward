...
planning_status: P0_BUILDING_BUTTON_THUMBNAIL_RUNTIME_CONSUMER_COMPLETE
current_next_gate: P1_STRUCTURE_CONSUMER_DISCOVERY_AND_APPROVED_SOURCE_MAPPING
...
PROJECT_ACTIVITY = P0_BUILDING_BUTTON_THUMBNAIL_RUNTIME_CONSUMER_COMPLETE
...
CURRENT_PROCESS = P0_BUILDING_BUTTON_THUMBNAIL_RUNTIME_CONSUMER_COMPLETE
CURRENT_NEXT = P1_STRUCTURE_CONSUMER_DISCOVERY_AND_APPROVED_SOURCE_MAPPING
IMPLEMENTATION_AUTHORITY = SCOPED_APPROVED_RETAINED
