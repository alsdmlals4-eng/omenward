...
planning_status: FIRST5_FTUE_CORE_LOOP_RECONCILIATION__OPEN_BATTLEFIELD_TOWER_ONLY_LAYOUT_CONFIRMED
...
7. `docs/handoffs/2026-08-28-open-battlefield-tower-only-layout-handoff.md`
