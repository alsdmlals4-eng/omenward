...
→ APPROVED_OMENWARD_VEIL_ONTOLOGY_2026-08-02.md
...
| 베일 본질·법칙·균열·상흔 | `design/APPROVED_OMENWARD_VEIL_ONTOLOGY_2026-08-02.md` | `USER_APPROVED_WORLD_ONTOLOGY / DETAILS_PENDING` |
...
- 베일은 현실과 이질적인 외부 법칙 영역이 겹칠 때 생기는 접촉면과 과정이다.
...
= 오멘워드 조직·루메른 왕국·지휘관의 정치적 위치
```

이 결정 전에는 오멘워드를 왕실 직속군·독립 기사단·종교기관·다국적 조직 중 하나로 임의 확정하지 않는다.
...
| 베일·법칙·균열·상흔 | Veil Ontology | Sheet `11_세계관`, World Run Motivation |
| 세계·MapRun·징조·승패 | World Run Motivation | Veil Ontology·기존 명칭 계보 |
| 왕국·오멘워드·지휘관 | 후속 Political Role Decision | 기존 명칭은 자동 확정 금지 |
| 베일종·경계파쇄자 | 후속 Veil Species Decision | 베일 자체와 행위 주체 분리 |
...
VEIL_NON_SENTIENT != VEIL_SPECIES_MINDLESS
```
