...
첫 상인은 Stage 1 정비시간에 등장하고 선택 사항·골드 기회비용만 설명한다. 첫 건설 후보·최소 유효 경로·Danger/Boss 세부·실패 규칙·정확 시간은 `PENDING_GRILLME`다.
...
5/10 전술·마력 계보와 1~6/10 정본을 보존하며, 7/10은 첫 세션의 학습 형식과 Stage 1~5 노출 순서만 부분 승인한다.
