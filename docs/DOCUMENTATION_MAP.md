...
planning_status: FIRST5_FTUE_CORE_LOOP_RECONCILIATION__BASE_FORWARD_LAYOUT_CONFIRMED
...
7. `docs/handoffs/2026-08-28-base-forward-battlefield-layout-handoff.md`
...
22. `docs/design/APPROVED_OMENWARD_BASE_FORWARD_BATTLEFIELD_CONSTRUCTION_LAYOUT_2026-08-28.md`
23. `docs/reviews/ADVERSARIAL_BASE_FORWARD_BATTLEFIELD_LAYOUT_REVIEW_2026-08-28.md`
...
- `docs/audits/OMENWARD_BASE_FORWARD_BATTLEFIELD_LAYOUT_INCIDENT_2026-08-28.md` — visible 본진 생산 시설과 실제 MapRun baseline을 분리하고, root/forward node·tower 수량 owner를 새 계약으로 이동했다.
- `docs/reviews/ADVERSARIAL_BASE_FORWARD_BATTLEFIELD_LAYOUT_REVIEW_2026-08-28.md` — 배치·FTUE·실구현 경계·생성 보드 오인을 5회 공격해 교정했으며, runtime/human evidence는 보류로 남긴다.
