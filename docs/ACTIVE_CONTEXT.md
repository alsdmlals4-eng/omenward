...
current_activity: BATTLEFIELD_MAP_AND_ROULETTE_PICKER_TECHNICAL_QA_COMPLETE__HUMAN_PLAYTEST_REMAINS
...
current_chat_runtime_status: PARTIAL__RUN_COMMAND_PREPARE_TO_BATTLE_LIVE_CAPTURED_AND_THREE_RESOLUTION_TECHNICAL_QA
