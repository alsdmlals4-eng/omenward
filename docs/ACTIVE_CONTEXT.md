...
- 갱신일: 2026-07-22
- 공식명: **오멘워드 / OMENWARD**
- 저장소 상태: **C1 룰렛 REMOTE_PROVEN / C2 전투 목적 구현 후보·원격 검증 진행 / 사람 플레이 미검증**
...
- C2 구현 후보는 같은 라인 교전→접전지→중간거점→성문→본진·W15 보스→승패와 실제 소유 수 경제를 연결한다.
...
- PR #49는 main에 병합됐다. PR #50은 C2 전투 목적 루프 구현 후보와 문서·검증 동기화를 다룬다.
