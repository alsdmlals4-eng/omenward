...
status: FIVE_SEQUENTIAL_FRONT_MAPS__USER_CONFIRMED__IMPLEMENTATION_AUTHORIZED
...
current_activity: FIVE_SEQUENTIAL_FRONT_MAPS_V1__USER_CONFIRMED__RESEARCHED__FEASIBLE__SPECIFIED__IMPLEMENTATION_AUTHORIZED
...
retained_open_battlefield_visual_direction_lock: docs/design/APPROVED_OMENWARD_OPEN_BATTLEFIELD_V6_VISUAL_DIRECTION_LOCK_2026-08-29.md
current_visual_spec: docs/design/APPROVED_OMENWARD_BATTLE_PRIMARY_MARCH_MINIMAP_2026-08-30.md
current_visual_decision: OMW-PLAN-20260830-BATTLE-PRIMARY-MARCH-MINIMAP-01
current_sequential_front_maps_decision: OMW-PLAN-20260902-FIVE-SEQUENTIAL-FRONT-MAPS-01
current_sequential_front_maps_spec: docs/design/APPROVED_OMENWARD_FIVE_SEQUENTIAL_FRONT_MAPS_2026-09-02.md
current_blueprint: OMW-BLUEPRINT-20260902-FIVE-SEQUENTIAL-FRONT-MAPS-V1
current_blueprint_spec: docs/superpowers/specs/2026-09-02-five-sequential-front-maps-design.md
current_blueprint_execution_plan: docs/superpowers/plans/2026-09-02-five-sequential-front-maps-implementation.md
current_sequential_front_maps_live_entry_qa: docs/qa/OMENWARD_FIVE_SEQUENTIAL_FRONT_MAPS_RUNTIME_SMOKE_2026-09-02.md
current_sequential_front_maps_adversarial_review: docs/reviews/ADVERSARIAL_FIVE_SEQUENTIAL_FRONT_MAPS_IMPLEMENTATION_REVIEW_2026-09-02.md
current_battle_primary_hierarchy_qa: docs/qa/OMENWARD_BATTLE_PRIMARY_HIERARCHY_RUNTIME_SMOKE_2026-09-02.md
current_visual_topology: ONE_WARD_CITADEL__ONE_ACTIVE_MARCH_FRONT__ONE_VEIL_CITADEL
retained_open_battlefield_visual_board_file: docs/images/planning/generated/OMENWARD_PROJECT_CORE_SCENE_VISUAL_BOARD_2026-08-28_v6_OPEN_BATTLEFIELD_NO_BARRICADE.png
...
current_battle_focus_owner: scripts/ui/battle_focus_view.gd__V2_ROLE_CELL__IMPLEMENTED__FULL_HEADLESS_CONTRACTS_PASS__RUNTIME_TECHNICAL_SMOKE_PASS
current_march_minimap_owner: scripts/ui/march_minimap_view.gd__V2_SINGLE_ROW_CONTEXT_RIBBON__IMPLEMENTED__FULL_HEADLESS_CONTRACTS_PASS__RUNTIME_TECHNICAL_SMOKE_PASS
current_wide_connected_terrain_asset: SUPERSEDED_FOR_SINGLE_FRONT__RETAINED_HISTORY
current_wide_connected_terrain_status: NOT_A_CURRENT_RUNTIME_CONSUMER
legacy_runtime_visual_asset: OMW-IMG-20260828-BATTLEFIELD-BACKDROP-V1__RETAINED__NOT_CONSUMED_BY_BATTLEFOCUSVIEW
current_build_runtime_unit_asset_set: STORYBOOK_SD_SHIELD_GUARD_PAIR_V1__LUMERN_ARCHER_MAGE_EXACT_APPROVED_PAIR_V1__VEIL_MONSTER_ROLE_VARIANTS_V1__IMPLEMENTED__MACHINE_VERIFIED__RUNTIME_TECHNICAL_SMOKE_PASS
...
current_storybook_archer_mage_pair: docs/images/approved/OMENWARD_STORYBOOK_ARCHER_MAGE_PAIR_SET_V1.md
current_storybook_spear_cavalry_authority: docs/images/approved/OMENWARD_STORYBOOK_SPEAR_CAVALRY_AUTONOMOUS_PRODUCTION_V2.md
current_storybook_role_profile_qa: docs/qa/OMENWARD_STORYBOOK_ROLE_PROFILE_BATTLEFOCUS_RUNTIME_2026-09-02.md
current_storybook_role_profile_review: docs/reviews/ADVERSARIAL_STORYBOOK_ROLE_PROFILE_IMPLEMENTATION_REVIEW_2026-09-02.md
current_storybook_veil_monster_role_variants: docs/images/approved/OMENWARD_VEIL_MONSTER_ROLE_VARIANTS_V1.md
current_storybook_veil_monster_role_qa: docs/qa/OMENWARD_VEIL_MONSTER_ROLE_PROFILE_BATTLEFOCUS_RUNTIME_2026-09-02.md
current_storybook_veil_monster_role_review: docs/reviews/ADVERSARIAL_VEIL_MONSTER_ROLE_PROFILE_VARIANTS_2026-09-02.md
...
role_profile_implementation_evidence: FULL_HEADLESS_GODOT_33_OF_33__FULL_PYTHON_570_PASS__VEIL_MONSTER_ROLE_RUNTIME_TECHNICAL_SMOKE_PASS__HUMAN_NOT_RUN
implementation_packet: docs/implementation/OMENWARD_RUN_COMMAND_VERTICAL_SLICE_WORK_PRODUCTION_INPUT_PACKET_2026-08-27.md
implementation_plan: docs/superpowers/plans/2026-08-30-battle-primary-march-minimap.md
...
workspace_hygiene: TEMPORARY_WORKTREES_AND_TEMPORARY_BRANCHES__DELETE_AFTER_OWNERSHIP_AND_ROLLBACK_AUDIT
temporary_file_hygiene: TASK_LOCAL_TEMPORARY_FILES__DELETE_IMMEDIATELY_AFTER_VERIFICATION
asset_cleanup_boundary: ACTIVE_RUNTIME_AND_CANONICAL_EVIDENCE_ONLY__SUPERSEDED_BINARY_DELETION_REQUIRES_ARCHIVE_GATE
...
current_chat_runtime_status: CLOSE_SINGLE_FRONT_BATTLEFIELD__FULL_HEADLESS_SUITE_PASS__LIVE_CAPTURED_TECHNICAL_SMOKE_PASS__HUMAN_NOT_RUN
current_battle_primary_hierarchy_runtime_status: V2__GODOT_34_OF_34__PYTHON_570_OF_570__LIVE_CAPTURED_TECHNICAL_SMOKE_PASS__HUMAN_NOT_RUN
role_profile_chat_runtime_status: STORYBOOK_ROLE_PROFILE_VEIL_MONSTER_VARIANTS__33_HEADLESS_AND_570_PYTHON_CONTRACTS_PASS__LIVE_CAPTURED_TECHNICAL_SMOKE_PASS__HUMAN_NOT_RUN
current_ci_gate_repair: PR_257__APPROVED_PROTECTED_CHANGE_ROUTING__LOCAL_AND_REMOTE_CI_PASS
current_ci_gate_repair_record: docs/audits/OMENWARD_APPROVED_PROTECTED_CHANGE_CI_ROUTING_INCIDENT_2026-08-31.md
current_ci_gate_repair_remote_head: 0b045c5ddeb1193333565cc11438acd120796339
...
FORWARD_DEFENSE_OCCUPATION_NODE_STATUS = SUPERSEDED_IN_SCOPE__GLOBAL_ROSTER_PHASE2
...
RUN_COMMAND_IMPLEMENTATION_EXECUTION = BATTLE_PRIMARY_MARCH_MINIMAP_AND_MODULAR_CLOSE_BATTLEFIELD__FULL_HEADLESS_SUITE_PASS__RUNTIME_TECHNICAL_SMOKE_PASS__HUMAN_REMAINS
HISTORICAL_PRE_APPROVAL_GATE = IMPLEMENTATION_AUTHORITY_REQUIRED
PROJECT_ACTIVITY = FIVE_SEQUENTIAL_FRONT_MAPS_V1__IMPLEMENTATION_IN_PROGRESS__PREVIOUS_BATTLE_HIERARCHY_MACHINE_VERIFIED
...
TITLE_ENTRY = USER_APPROVED__TITLE_ASSETS_CANON_REGISTERED__IMPLEMENTED__MACHINE_VERIFIED__RUNTIME_TECHNICAL_SMOKE_PASS__HUMAN_NOT_RUN
TITLE_ENTRY_ASSET_GATE = LOCKED__MACHINE_VERIFIED__RUNTIME_TECHNICAL_SMOKE_PASS__HUMAN_AND_RIGHTS_REVIEW_PENDING
CURRENT_NEXT = RUNTIME_TECHNICAL_SMOKE_OF_SEQUENTIAL_FRONT_TRANSITION__THEN_USER_VISUAL_CONFIRMATION
ROLE_PROFILE_CURRENT_NEXT_DETAIL = VEIL_MONSTER_COMBAT_PRODUCED_MIXED_ROSTER_READABILITY_CHECK__RUNTIME_CAPTURE_AVAILABLE
VISUAL_GENERATION_POLICY = USER_AUTHORIZED_AUTONOMOUS_REQUIRED_IMAGES
...
PHASE2_GLOBAL_ROSTER_MACHINE_QA = INCLUDED_IN_HEADLESS_GODOT_CONTRACTS_PASS
STRATEGIC_MAP_UI = SUPERSEDED_AS_PRIMARY_SURFACE__MARCH_MINIMAP_IMPLEMENTED
WIDE_CONNECTED_THREE_FRONT_TERRAIN = SUPERSEDED_FOR_CURRENT_RUNTIME_CONSUMER
STORYBOOK_UNIT_SOURCE_SHEETS = RETAINED_SOURCE_SHEET_REFERENCE__ROLE_PROFILE_RUNTIME_SET_PARTIALLY_PROMOTED
```
...
`HISTORICAL_PRE_APPROVAL_GATE`는 2026-08-24 implementation 승인 이전의 과거 gate를 보존하는 호환 marker이며 현재 다음 작업이 아니다. 기존 승인 Shield Guard pair와 legacy backdrop은 보존하되, close battle view의 runtime consumer는 승인된 modular foundation/prop bundle로 교체했다. 새 단일 전선 지형은 `assets/`와 `BattleFocusView`에 연결되었고 live technical smoke까지 완료했다. 현재 gate는 사람 사용성과 다수 유닛 교전 가독성 확인이다.

`OMW-PLAN-20260830-BATTLE-PRIMARY-MARCH-MINIMAP-01` is the current presentation owner. It retains the single five-sector route and `내정 / 룰렛 / 전선` work surfaces, but makes a close live battle view primary and the route a read-only march minimap. The 2026-08-28 three-front owner is retained only for storybook-watercolor material language and silhouette principles; its topology and terrain consumer are superseded.
...
- `docs/superpowers/specs/2026-08-31-omen-warden-title-entry-design.md` — boot-to-tutorial title-entry implementation with the approved background and wordmark bound; human and rights review remain open.
- `docs/images/approved/OMENWARD_TITLE_ENTRY_ASSETS_V1.md` — exact user-approved title background/wordmark canonical copies, consumer, provenance, and rights ceiling.
- `docs/images/candidates/OMENWARD_TITLE_ENTRY_CANDIDATES_2026-08-31.md` — deleted title-candidate archive and promotion history.
- `docs/qa/OMENWARD_TITLE_ENTRY_RUNTIME_SMOKE_2026-08-31.md` — 32 Godot contracts, 569 Python contracts, and the locked-art technical runtime smoke; human usability remains open.
- `docs/reviews/ADVERSARIAL_TITLE_ENTRY_IMPLEMENTATION_REVIEW_2026-08-31.md` — native-route history plus locked-asset five-loop review; human and rights evidence remain open.
...
- `docs/reviews/ADVERSARIAL_STORYBOOK_SHIELD_GUARD_PAIR_IMPLEMENTATION_REVIEW_2026-08-30.md` — five machine-scope full reviews complete; target live runtime/human evidence remains open.
- `docs/images/approved/OMENWARD_STORYBOOK_ARCHER_MAGE_PAIR_SET_V1.md` — four exact user-approved Archer/Mage bytes, canon runtime copies, faction-role binding, and technical smoke evidence.
- `docs/images/approved/OMENWARD_STORYBOOK_SPEAR_CAVALRY_AUTONOMOUS_PRODUCTION_V2.md` — four separate standing-authority derivatives; not an individual user-byte approval.
- `docs/qa/OMENWARD_STORYBOOK_ROLE_PROFILE_BATTLEFOCUS_RUNTIME_2026-09-02.md` — `33` Godot and `570` Python contract evidence plus live BattleFocus capture; human readability remains open.
- `docs/reviews/ADVERSARIAL_STORYBOOK_ROLE_PROFILE_IMPLEMENTATION_REVIEW_2026-09-02.md` — five post-change machine/runtime-scope review loops; human and rights evidence remain open.
- `docs/images/approved/OMENWARD_VEIL_MONSTER_ROLE_VARIANTS_V1.md` — four active Veil monster variants under standing image authority; original V1/V2 bytes are preserved history, not current bindings.
- `docs/qa/OMENWARD_VEIL_MONSTER_ROLE_PROFILE_BATTLEFOCUS_RUNTIME_2026-09-02.md` — fresh `33 / 33` Godot technical evidence and a new live runtime capture; human readability remains open.
- `docs/reviews/ADVERSARIAL_VEIL_MONSTER_ROLE_PROFILE_VARIANTS_2026-09-02.md` — five-loop review of identity, provenance, alpha normalization, stale-capture prevention, and evidence ceiling.
...
PLAYER_FANTASY = 전조를 읽고 수호성을 준비하며 병력을 단일 행군 전선에 보내는 지휘관
...
CURRENT_HERA_LIVE_QA = TECHNICAL_SMOKE_PASS__CLOSE_SINGLE_FRONT_BATTLEFIELD__HUMAN_NOT_RUN
