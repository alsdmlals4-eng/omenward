...
PR #210 handoff closeout is historical and merged; resolve current main from the repository default branch. The current Gate is Run Command long-form runtime and human playtest; this document does not authorize wider product-scope implementation.
