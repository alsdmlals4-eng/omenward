...
- 갱신일: 2026-07-27
- 최신 정본: `docs/design/APPROVED_VERTICAL_SLICE_SYSTEM_CONTRACT_2026-07-27.md`
...
이 문서는 이미 승인된 구조를 다시 질문하는 목록이 아니다. 최신 통합 계약을 유지하고, 제품 구현 전에 실제 수치·콘텐츠·스키마로 고정해야 할 항목만 추적한다.

---

## 1. 2026-07-27까지 해결된 주요 결정
