...
source_precedence: current repository branch > current confirmed decisions > code/test evidence > derived PDF
overall_status: PARTIAL__BATTLE_PRIMARY_MACHINE_QA_CAPTURED__RUNTIME_TECHNICAL_SMOKE_PASS__HUMAN_PLAYER_EVIDENCE_NOT_RUN
known_stale_points: human usability and multi-unit combat readability remain unverified
...
PRESSURE_HAS_FIXED_FRONT_IDENTITY = FALSE
...
REDISTRIBUTION_AFTER_FINAL_COMMIT = FORBIDDEN
AUTOBATTLE = CORE
...
Current Decision: `OMW-PLAN-20260830-BATTLE-PRIMARY-MARCH-MINIMAP-01`. The single-front domain remains retained, while the wide strategic map is replaced by a close battle-primary view and a read-only march minimap.
...
```text
BATTLE_FOCUS_VIEW = CURRENT_UNITS + CURRENT_THREAT + CURRENT_CLASH + COMBAT_OUTCOME
MARCH_MINIMAP = WARD_CITADEL + WARD_FORWARD + CLASH + VEIL_FORWARD + VEIL_CITADEL
```

Current visual owners:
- `docs/design/APPROVED_OMENWARD_BATTLE_PRIMARY_MARCH_MINIMAP_2026-08-30.md` — current battle-primary and read-only minimap owner.
- `docs/design/APPROVED_OMENWARD_SINGLE_MARCH_FRONT_AND_THREE_TAB_COMMAND_2026-08-30.md` — retained topology, work-surface, one-tower, and one-route owner.
- `docs/images/approved/OMENWARD_CLOSE_SINGLE_FRONT_BATTLEFIELD_MODULAR_V1.md` — exact user-locked modular terrain bundle; bound and runtime technically smoked, human readability remains open.
...
CURRENT_NEXT = IMPLEMENT_FIVE_SEQUENTIAL_FRONT_MAPS_RED_FIRST__THEN_RUNTIME_SMOKE
...
- Current visual spec: `docs/design/APPROVED_OMENWARD_BATTLE_PRIMARY_MARCH_MINIMAP_2026-08-30.md`
- Approved visual asset: `docs/images/approved/OMENWARD_CLOSE_SINGLE_FRONT_BATTLEFIELD_MODULAR_V1.md`
