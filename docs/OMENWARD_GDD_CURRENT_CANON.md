...
Phase C Gate open은 runtime completion이 아니다.
...
Phase C C0에서 actual local plugin/server/session을 fresh verify한다.
...
- `reviews/PHASE_B_FINAL_PLANNING_REVIEW_2026-08-11.md`
