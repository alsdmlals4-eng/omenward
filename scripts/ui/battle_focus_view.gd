...
const VEIL_SPEAR_GUARD_TEXTURE := preload("res://assets/art/units/veil_spear_guard_storybook_idle_v3.png")
const LUMERN_ARCHER_TEXTURE := preload("res://assets/art/units/lumern_archer_storybook_idle_v1.png")
const VEIL_ARCHER_TEXTURE := preload("res://assets/art/units/veil_archer_storybook_idle_v2.png")
const LUMERN_CAVALRY_TEXTURE := preload("res://assets/art/units/lumern_cavalry_storybook_idle_v2.png")
const VEIL_CAVALRY_TEXTURE := preload("res://assets/art/units/veil_cavalry_storybook_idle_v3.png")
const LUMERN_MAGE_TEXTURE := preload("res://assets/art/units/lumern_mage_storybook_idle_v1.png")
const VEIL_MAGE_TEXTURE := preload("res://assets/art/units/veil_mage_storybook_idle_v2.png")
