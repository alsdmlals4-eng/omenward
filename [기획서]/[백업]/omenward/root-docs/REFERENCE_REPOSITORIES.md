...
- Base: `alsdmlals4-eng/Base` 기준 커밋 `e05e198d9c003623f1a117fa1d4505e97117990e`
...
- `../../09_프로덕션_PM/등록_부록/HANDOFF_CONTEXT.md`를 콜드 스타트 시작점으로 사용.
...
1. `../../09_프로덕션_PM/등록_부록/HANDOFF_CONTEXT.md`에서 현재 방향과 불변 조건을 확인한다.
