...
- 최신 통합 기준: `../../02_게임_디자인/등록_부록/APPROVED_PREPRODUCTION_POC_BASELINE_V1.md`
- 시각자료 인덱스: `../../06_아트/증거/VISUAL_REFERENCE_INDEX.md`
- 병종 비주얼 형식: `../../06_아트/등록_부록/APPROVED_UNIT_VISUAL_FORMAT_AND_REFERENCE_USE_V1.md`
...
`../../06_아트/증거/VISUAL_REFERENCE_INDEX.md`에 다음 자료의 존재와 처리 상태를 기록했다.
...
2. `../../06_아트/증거/VISUAL_REFERENCE_INDEX.md`에 상태와 경로 등록.
