...
이 문서는 구현이 뒤집히지 않도록 오멘워드의 승인 구조, 첫 PoC 가설, 책임 문서와 다음 실행 게이트를 통합한다. 최초 인수인계는 `../../09_프로덕션_PM/등록_부록/HANDOFF_CONTEXT.md`를 사용한다.
...
- 공통 전투: `APPROVED_COMMON_COMBAT_AND_RANK_BUDGET_POC_V1.md`
- 공용 병종 데이터·진영 이미지: `../../06_아트/등록_부록/APPROVED_SHARED_UNIT_ARCHETYPE_AND_FACTION_VISUAL_DATA_V1.md`
- 병종 능력 계보: `APPROVED_PLAYER_TEN_UNIT_LINEAGES_POC_V1.md`
- 룰렛: `APPROVED_ROULETTE_PROBABILITY_TARGETS_POC_V1.md`
- W1~20 웨이브·보스: `APPROVED_SHARED_ARCHETYPE_WAVE_1_20_POC_V1.md`
- 건물·전술·용병: `APPROVED_BUILDINGS_TACTICAL_MERCENARY_POC_V1.md`
- 튜토리얼·캠페인·절차 생성: `../../03_UX_UI_접근성/등록_부록/APPROVED_TUTORIAL_CAMPAIGN_PROCEDURAL_POC_V1.md`
- UI·오디오: `../../06_아트/등록_부록/APPROVED_UI_ART_AUDIO_POC_BIBLE_V1.md`
- 아트 제작: `../../06_아트/등록_부록/APPROVED_ART_DIRECTION_AND_PRODUCTION_GUIDE_V1.md`
- 애니메이션·전투 연출: `../../06_아트/등록_부록/APPROVED_UNIT_ANIMATION_AND_BATTLE_PRESENTATION_GUIDE_V1.md`
