...
`LEGACY_C1_C2_C3_PROVEN`은 2026-07의 정확한 기술 증거가 역사적으로 존재한다는 뜻이며 현재 v4.7 제품 경험 PASS가 아니다. 정확한 head/run은 전용 audit/archive evidence owner에서 검증한다.
...
No current document may restore those historical states as current implementation authority.
