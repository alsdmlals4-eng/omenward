...
CURRENT_REACTIVATION_GATE = "PHASE2_STORYBOOK_UNIT_RUNTIME_ASSETS__ISSUE_256__SOURCE_SHEETS_GENERATED__TRUE_ALPHA_CELL_EXPORT_PENDING_REVIEW"
...
class CurrentCanonReconciliationTests(unittest.TestCase):
    ...
    def test_current_decision_count_matches_registered_table(self) -> None:
        ...
        self.assertEqual(28, len(table_ids))
    ...
    def test_final_planning_review_remains_retained_evidence_without_reactivating_execution(self) -> None:
        ...
        self.assertIn("RUN_COMMAND_IMPLEMENTATION_EXECUTION = IMPLEMENTED__MACHINE_QA_AND_HUMAN_PLAYTEST_REMAIN", active)
