...
class ContractTests(unittest.TestCase):
    ...
    def test_project_profile_fails_closed_on_platform_decision(self):
        text = PROFILE.read_text(encoding="utf-8")
        for token in ("LOWEST_VIABLE_RATING", "AVOID_ADULTS_ONLY", "PLATFORM_DECISION_REQUIRED", "UNDECIDED", "Steam", "STOVE", "Google_Play", "ALL_OR_12_CANDIDATE", "RELEASE_BLOCKED_UNVERIFIED", "PLATFORM_SUBMISSION_NOT_RUN", "LEGAL_REVIEW_NOT_PERFORMED"):
    ...
    def test_release_pack_and_agents_routing(self):
        ...
        for token in ("build_store_questionnaire_consistency", "asset_rights_coverage", "PLATFORM_DECISION_REQUIRED", "RELEASE_BLOCKED_UNVERIFIED"):
