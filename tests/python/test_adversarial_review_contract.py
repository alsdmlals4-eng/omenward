...
class AdversarialReviewContractTests(unittest.TestCase):
    ...
    def test_review_stack_cannot_omit_integration(self) -> None:
        self.assertIn("foundation.validation-review", REGISTRY["routing"]["review_stack"])
        self.assertIn("discipline.integration-review", REGISTRY["routing"]["review_stack"])
