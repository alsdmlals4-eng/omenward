...
class CanonFreshnessV45RoutingTest(unittest.TestCase):
    ...
    def test_current_routers_use_v48_and_current_visual_closeout(self) -> None:
        ...
        self.assertIn("status: FIRST5_FTUE_CORE_LOOP_RECONCILIATION__GLOBAL_BUILDING_ROSTER_PHASE2_ACTIVE", active)
        self.assertIn("CURRENT_APPROVED_REPLAN_DECISIONS = 28", active)
        self.assertIn("CURRENT_NEXT = PHASE2_GLOBAL_BUILDING_ROSTER_AND_OCCUPATION_SLOT_MIGRATION__ISSUE_255__MACHINE_VERIFIED__RUNTIME_TARGET_RESOLUTION_REQUIRED", active)
