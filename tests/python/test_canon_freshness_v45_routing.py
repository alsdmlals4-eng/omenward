...
class CanonFreshnessV45RoutingTest(unittest.TestCase):
    ...
    def test_current_routers_use_v48_and_current_visual_closeout(self) -> None:
        ...
        self.assertIn("status: FIRST5_FTUE_CORE_LOOP_RECONCILIATION__TERRAIN_IMPLEMENTED__UNIT_SOURCE_SHEETS_GENERATED", active)
        self.assertIn("CURRENT_APPROVED_REPLAN_DECISIONS = 28", active)
        self.assertIn("CURRENT_NEXT = PHASE2_STORYBOOK_UNIT_RUNTIME_ASSETS__ISSUE_256__SOURCE_SHEETS_GENERATED__TRUE_ALPHA_CELL_EXPORT_PENDING_REVIEW", active)
