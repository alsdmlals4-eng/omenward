...
class CanonFreshnessV45RoutingTest(unittest.TestCase):
    ...
    def test_current_routers_use_v48_and_current_visual_closeout(self) -> None:
        ...
        self.assertIn("CURRENT_APPROVED_REPLAN_DECISIONS = 31", decisions)
        ...
        self.assertIn("status: FIVE_SEQUENTIAL_FRONT_MAPS__USER_CONFIRMED__IMPLEMENTATION_AUTHORIZED", active)
        self.assertIn("CURRENT_APPROVED_REPLAN_DECISIONS = 31", active)
        self.assertIn("CURRENT_NEXT = RUNTIME_TECHNICAL_SMOKE_OF_SEQUENTIAL_FRONT_TRANSITION__THEN_USER_VISUAL_CONFIRMATION", active)
