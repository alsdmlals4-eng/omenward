...
class CanonFreshnessV45RoutingTest(unittest.TestCase):
    ...
    def test_current_routers_use_v48_and_current_visual_closeout(self) -> None:
        ...
        self.assertIn("CURRENT_APPROVED_REPLAN_DECISIONS = 26", decisions)
        ...
        self.assertIn("PROJECT_CORE_SCENE_VISUAL_BOARD = GENERATED_EXPLORATION__V5_BASE_FORWARD_NODE_LAYOUT__USER_CONFIRM_PENDING", decisions)
        ...
        self.assertIn("status: FIRST5_FTUE_CORE_LOOP_RECONCILIATION__BASE_FORWARD_BATTLEFIELD_BOARD_USER_CONFIRM_PENDING", active)
        self.assertIn("CURRENT_APPROVED_REPLAN_DECISIONS = 26", active)
        self.assertIn("CURRENT_NEXT = USER_CONFIRM_REVISED_BASE_FORWARD_BATTLEFIELD_PLANNING_BOARD", active)
