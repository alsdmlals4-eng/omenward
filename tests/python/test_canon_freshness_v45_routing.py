...
class CanonFreshnessV45RoutingTest(unittest.TestCase):
    ...
    def test_current_routers_use_v48_and_current_visual_closeout(self) -> None:
        ...
        self.assertIn("CURRENT_APPROVED_REPLAN_DECISIONS = 28", decisions)
        ...
        self.assertIn("CURRENT_TARGET_RUNTIME_ASSET = OMW-IMG-20260830-WIDE-CONNECTED-STRATEGIC-FRONT-TERRAIN-V1", decisions)
        ...
        self.assertIn("status: FIRST5_FTUE_CORE_LOOP_RECONCILIATION__TERRAIN_AND_SHIELD_GUARD_PAIR_IMPLEMENTED__REMAINING_SOURCE_CELLS_PENDING_REVIEW", active)
        self.assertIn("CURRENT_APPROVED_REPLAN_DECISIONS = 28", active)
        self.assertIn("CURRENT_NEXT = PHASE2_STORYBOOK_REMAINING_UNIT_RUNTIME_ASSETS__ISSUE_256__SOURCE_SHEETS_GENERATED__TRUE_ALPHA_CELL_EXPORT_PENDING_REVIEW", active)
