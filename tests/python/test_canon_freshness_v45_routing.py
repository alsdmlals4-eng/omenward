...
class CanonFreshnessV45RoutingTest(unittest.TestCase):
    ...
    def test_current_routers_use_v48_and_current_visual_closeout(self) -> None:
        ...
        self.assertIn("CURRENT_APPROVED_REPLAN_DECISIONS = 24", decisions)
        ...
        self.assertIn("status: FIRST5_FTUE_CORE_LOOP_RECONCILIATION__FORWARD_TOWER_DECISION_PENDING", active)
        self.assertIn("CURRENT_APPROVED_REPLAN_DECISIONS = 24", active)
        self.assertIn("CURRENT_NEXT = USER_GRILL_ME_ON_FORWARD_TOWER_PLAYER_VALUE", active)
