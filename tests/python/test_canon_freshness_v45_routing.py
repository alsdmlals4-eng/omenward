...
class CanonFreshnessV45RoutingTest(unittest.TestCase):
    ...
    def test_current_routers_use_v48_and_current_visual_closeout(self) -> None:
        ...
        self.assertIn("CURRENT_APPROVED_REPLAN_DECISIONS = 25", decisions)
        ...
        self.assertIn("status: FIRST5_FTUE_CORE_LOOP_RECONCILIATION__FORWARD_DEFENSE_GDD_REVIEW_PENDING", active)
        self.assertIn("CURRENT_APPROVED_REPLAN_DECISIONS = 25", active)
        self.assertIn("CURRENT_NEXT = USER_REVIEW_OF_FORWARD_DEFENSE_AND_OCCUPATION_NODE_GDD", active)
