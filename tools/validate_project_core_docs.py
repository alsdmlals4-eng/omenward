...
CURRENT_REACTIVATION_GATE = "RUN_COMMAND_VERTICAL_SLICE_FULL_SCOPE_MACHINE_QA_AND_HUMAN_PLAYTEST"
...
def validate(root: pathlib.Path = ROOT) -> list[str]:
    ...
    require(
        ...
        (
            ...
            IMPLEMENTATION_PACKET,
            IMPLEMENTATION_PLAN,
            "RUNTIME_EVIDENCE = PARTIAL__HEADLESS_CONTRACTS_AND_HERA_TECHNICAL_SMOKE",
    ...
    require(
        ...
        (
            ...
            "implementation_execution: IMPLEMENTED__HEADLESS_CONTRACTS_AND_HERA_TECHNICAL_SMOKE_PASS__HUMAN_NOT_RUN",
            f"CURRENT_NEXT = {CURRENT_REACTIVATION_GATE}",
            "CURRENT_GODOT_RUNTIME = PARTIAL__RUN_COMMAND_UI_TECHNICAL_SMOKE_CAPTURED",
            "CURRENT_GUT_RED = NOT_RUN",
            "CURRENT_GUT_GREEN = NOT_RUN",
            "CURRENT_HERA_LIVE_QA = PARTIAL__RUN_COMMAND_PREPARE_TO_BATTLE_INTERACTION_AND_DIAGNOSTICS_CLEAN",
