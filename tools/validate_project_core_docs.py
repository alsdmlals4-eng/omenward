...
CURRENT_REACTIVATION_GATE = "USER_EXPLICIT_IMG_02_01_GENERATION_APPROVAL"
...
def validate(root: pathlib.Path = ROOT) -> list[str]:
    ...
    require(
        ...
        (
            ...
            "PROJECT_STATE = PAUSED_AT_IMG_02_GENERATION_APPROVAL_GATE",
    ...
    require(
        ...
        (
            CURRENT_CONTRACT,
            "status: PAUSED_AT_IMG_02_GENERATION_APPROVAL_GATE",
            "CURRENT_APPROVED_REPLAN_DECISIONS = 21",
            CURRENT_VISUAL_DECISION_ID,
    ...
    require(
        ...
        (
            ...
            "current_image_package_status: SHIELD_GUARD_CLEANUP_MASTER_PAIR_USER_APPROVED",
            "image_generation: USER_REQUEST_ONLY",
