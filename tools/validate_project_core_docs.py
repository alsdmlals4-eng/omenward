...
CURRENT_REACTIVATION_GATE = "RUNTIME_TECHNICAL_SMOKE_OF_SEQUENTIAL_FRONT_TRANSITION__THEN_USER_VISUAL_CONFIRMATION"
CURRENT_ACTIVITY = "FIVE_SEQUENTIAL_FRONT_MAPS__USER_CONFIRMED__IMPLEMENTATION_AUTHORIZED"
...
CURRENT_VISUAL_DECISION_ID = "OMW-PLAN-20260830-BATTLE-PRIMARY-MARCH-MINIMAP-01"
HISTORICAL_THREE_FRONT_VISUAL_DECISION_ID = "OMW-VISUAL-20260828-STORYBOOK-SD-THREE-FRONT-STRATEGIC-MAP-01"
...
CURRENT_VISUAL_ASSET = "docs/images/approved/OMENWARD_CLOSE_SINGLE_FRONT_BATTLEFIELD_MODULAR_V1.md"
CURRENT_CLOSE_BATTLEFIELD_SMOKE = "docs/qa/OMENWARD_CLOSE_SINGLE_FRONT_BATTLEFIELD_RUNTIME_SMOKE_2026-08-31.md"
CURRENT_CLOSE_BATTLEFIELD_REVIEW = "docs/reviews/ADVERSARIAL_CLOSE_SINGLE_FRONT_BATTLEFIELD_IMPLEMENTATION_REVIEW_2026-08-31.md"
...
CURRENT_RUNTIME_EVIDENCE = "CURRENT_GODOT_RUNTIME = PARTIAL__BATTLE_PRIMARY_MACHINE_VERIFIED__MODULAR_CLOSE_BATTLEFIELD_RUNTIME_TECHNICAL_SMOKE_PASS"
...
REQUIRED_FILES = (
    ...
    CURRENT_CLOSE_BATTLEFIELD_SMOKE,
    CURRENT_CLOSE_BATTLEFIELD_REVIEW,
...
def validate(root: pathlib.Path = ROOT) -> list[str]:
    ...
    require(
        ...
        "current battle-primary visual spec",
    )
    ...
    require(
        ...
        (
            ...
            HISTORICAL_THREE_FRONT_VISUAL_DECISION_ID,
    ...
    require(
        ...
        "current modular battlefield asset record",
    )

    legacy_visual_asset = read(root, LEGACY_RUNTIME_VISUAL_ASSET)
    require(
        errors,
        legacy_visual_asset,
        (
    ...
    require(
        ...
        "current battle-primary handoff",
    )
    ...
    require(
        ...
        (
            ...
            "human_usability: NOT_RUN",
            "player_experience: NOT_RUN",
            "NEXT_GATE = PHASE2_STORYBOOK_REMAINING_UNIT_RUNTIME_ASSETS__ISSUE_256__SOURCE_SHEETS_GENERATED__TRUE_ALPHA_CELL_EXPORT_PENDING_REVIEW",
        ),
