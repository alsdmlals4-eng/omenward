...
CURRENT_RUNTIME_EVIDENCE = "CURRENT_GODOT_RUNTIME = PARTIAL__BATTLE_PRIMARY_MACHINE_VERIFIED__RUNTIME_NOT_RUN"
...
def validate(root: pathlib.Path = ROOT) -> list[str]:
    ...
    require(
        ...
        (
            ...
            "기존 승인 Shield Guard 양 진영 페어와 기존 runtime backdrop만 첫 구현에 사용한다.",
            "human_validation: NOT_RUN",
        ),
