...
CURRENT_ACTIVITY = "SINGLE_MARCH_FRONT_THREE_TAB_COMMAND__USER_CONFIRMED__IMPLEMENTATION_AUTHORIZED"
...
CURRENT_VISUAL_DECISION_ID = "OMW-PLAN-20260830-SINGLE-MARCH-FRONT-THREE-TAB-01"
...
def validate(root: pathlib.Path = ROOT) -> list[str]:
    ...
    require(
        ...
        (
            ...
            "USER_APPROVAL_OF_NEW_GENERATED_ASSET",
            "human_validation: NOT_RUN",
        ),
        "current single-march visual spec",
    )
