...
class BCAAdoptionTests(unittest.TestCase):
 ...
 def test_registry(self):
  r=json.loads((ROOT/"skills/SKILL_REGISTRY.json").read_text(encoding="utf-8")); self.assertEqual(r["base_source"]["commit"],BASE_SHA); self.assertEqual(r["bca_visual_sheet"]["spreadsheet_id"],SHEET_ID); self.assertIn("15_조작_게임규칙",r["bca_visual_sheet"]["required_tabs"])
