...
ACTIVATION_ALLOWED_FILES = {
    ".github/workflows/validate-active-integrated-contract-v4-4.yml", ".github/workflows/validate-canon-freshness-v4-5.yml",
    ...
    "docs/superpowers/plans/2026-08-11-canon-freshness-v45-routing.md", "tests/python/test_canon_freshness_v45_routing.py",
    "tests/python/test_canon_freshness_v45_scope.py", "tools/validate_canon_freshness_v45_scope.py",
}
ACTIVATION_REQUIRED_ANCHORS = {
    "docs/process/ACTIVE_INTEGRATED_CONTRACT_BINDING_2026-08-11.md", "docs/operations/ACTIVE_INTEGRATED_CONTRACT_STATE.v2.json",
    "docs/process/PROJECT_TOTAL_PLANNING_IMPLEMENTATION_AND_DELIVERY_INSTRUCTION_v4.5_r2.md",
...
CONTENT_CLOSURE_BENCHMARK_FIRST_ALLOWED_FILES = {
    ".github/workflows/validate-canon-freshness-v4-5.yml", "AGENTS.md", "docs/ACTIVE_CONTEXT.md", "docs/DECISIONS_PENDING.md",
    "docs/DOCUMENT_LIFECYCLE_REGISTRY.md", "docs/OMENWARD_GDD_CURRENT_CANON.md",
    ...
    "tests/python/test_content_closure_benchmark_first.py", "tests/python/test_canon_freshness_v45_scope.py",
