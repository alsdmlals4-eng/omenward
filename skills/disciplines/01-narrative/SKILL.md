...
description: Omenward의 설정·내러티브 책임 원본·구현·검증을 갱신할 때 자동 선택한다.
---
...
Trigger: `narrative`, `worldbuilding`, `naming`, `lore`, `bellu`

**Use when:** 세계관·공식 명칭·벨루·베일의 법칙·서사 표현을 변경하거나 검수할 때.

**Do not use when:** 전투 수치·코드만 바꾸며 설정 표현에 영향이 없을 때.

이 Skill은 프로젝트 주 책임 분야 Skill이며 동시에 최대 1개를 기본 선택한다. 필요한 Foundation/Specialist Skill만 별도로 조합한다.

## Canonical source

- Responsibility source: `[기획서]/01_설정_내러티브/01_설정_내러티브_본책.md`
...
공식명과 확정 세계관을 보존하고 새 설정은 승인 상태·출처·재검토 조건을 기록한다.
